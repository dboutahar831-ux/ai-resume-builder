      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1.5">Choose a new password for your account</p>
          </div>
          ...
          {done ? (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-900 mb-6">Password has been reset. Redirecting to login…</p>
            </div>
          ) : (
              ...
              <div>
                ...
                <div className="relative">
                  <input type={showPw ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)}
                    ...
                    className="w-full pr-10 px-4 py-2.5 bg-gray-100 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#6C5CE7]/30 focus:border-[#6C5CE7] transition-all" />
